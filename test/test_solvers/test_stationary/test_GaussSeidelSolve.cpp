...
TEST_F(GaussSeidel_Test, SolveConvDiff64Double) {
...
TEST_F(GaussSeidel_Test, SolveConvDiff256Double_LONGRUNTIME) {
...
TEST_F(GaussSeidel_Test, SolveConvDiff64Single) {
...
TEST_F(GaussSeidel_Test, SolveConvDiff256Single_LONGRUNTIME) {
...
TEST_F(GaussSeidel_Test, SolveConvDiff64Single_FailBeyondCapabilities) {
...
TEST_F(GaussSeidel_Test, SolveConvDiff64Half) {
...
TEST_F(GaussSeidel_Test, SolveConvDiff256Half_LONGRUNTIME) {
...
TEST_F(GaussSeidel_Test, SolveConvDiff64Half_FailBeyondCapabilities) {
