...
public:
    ...
    void TestOuterIterateCorrectSolvers() {
        ...
        GenericLinearSystem<M> lin_sys(M<double>::Random(2, 2),
                                       MatrixVector<double>::Random(2, 1));
        ...
        TypedLinearSystem<M, half> lin_sys_typ_hlf(M<double>(2, 2),
                                                   MatrixVector<double>(2, 1));
        GMRESSolve<M, half> type_test_half(lin_sys_typ_hlf, 1., default_args);
        ...
        TypedLinearSystem<M, float> lin_sys_typ_sgl(M<double>(2, 2),
                                                    MatrixVector<double>(2, 1));
        ...
        TypedLinearSystem<M, double> lin_sys_typ_dbl(M<double>(2, 2),
                                                     MatrixVector<double>(2, 1));
...
TEST_F(MP_GMRES_IR_ComponentTest, Test_Constructor) {
    ...
    GenericLinearSystem<MatrixSparse> lin_sys_sparse(MatrixSparse<double>(2, 2),
                                                     MatrixVector<double>(2, 1));
