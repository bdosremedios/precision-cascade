...
class Preconditioned_AP_GMRES_IR_Test: public TestBase
{
public:
...
TEST_F(Preconditioned_AP_GMRES_IR_Test, SolveMinimumIterTest_SOLVER) {
...
TEST_F(Preconditioned_AP_GMRES_IR_Test, SolveConvDiff256_SOLVER) {
...
TEST_F(Preconditioned_AP_GMRES_IR_Test, SolveConvDiff1024_LONGRUNTIME_SOLVER) {
