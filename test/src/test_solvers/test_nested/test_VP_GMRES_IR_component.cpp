...
class VP_GMRES_IR_ComponentTest: public TestBase
{
public:
...
TEST_F(VP_GMRES_IR_ComponentTest, Test_Constructor_SOLVER) {
    TestConstructor<MatrixDense>();
    TestConstructor<NoFillMatrixSparse>();
}

TEST_F(VP_GMRES_IR_ComponentTest, Test_SetCorrectPhaseSolvers_SOLVER) {
    TestOuterIterateCorrectSolvers<MatrixDense>();
    TestOuterIterateCorrectSolvers<NoFillMatrixSparse>();
}

TEST_F(VP_GMRES_IR_ComponentTest, Test_Reset_SOLVER) {
