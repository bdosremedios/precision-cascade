...
TEST_F(MatrixInversePreconditioner_Test, TestMatrixInversePreconditioner_PRECONDITIONER) {
    TestMatrixInversePreconditioner<MatrixDense>();
    TestMatrixInversePreconditioner<NoFillMatrixSparse>();
}

TEST_F(MatrixInversePreconditioner_Test, TestMatrixInverseCast_PRECONDITIONER) {
