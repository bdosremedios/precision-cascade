...
TEST_F(VectorSort_Test, TestSimpleSortHalf_EvenNum) { simple_sort_even<__half>(); }
...
TEST_F(VectorSort_Test, TestSimpleSortHalf_OddNum) { simple_sort_odd<__half>(); }
...
TEST_F(VectorSort_Test, TestSimpleSortHalf_Dupes) { simple_sort_duplicates<__half>(); }
