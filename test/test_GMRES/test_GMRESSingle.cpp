...
TEST_F(GMRESSingleTest, SolveConvDiff64) {
    ...
    GMRESSolveTestingMock<float> gmres_solve_s(A, b, u_sgl, 64, conv_tol_sgl);
...
TEST_F(GMRESSingleTest, SolveConvDiff256) {
    ...
    GMRESSolveTestingMock<float> gmres_solve_s(A, b, u_sgl, 256, conv_tol_sgl);
...
TEST_F(GMRESSingleTest, SolveConvDiff1024_LONGRUNTIME) {
    ...
    GMRESSolveTestingMock<float> gmres_solve_s(A, b, u_sgl, 1024, conv_tol_sgl);
...
TEST_F(GMRESSingleTest, SolveRand20) {
    ...
    GMRESSolveTestingMock<float> gmres_solve_s(A, b, u_sgl, 20, conv_tol_sgl);
...
TEST_F(GMRESSingleTest, Solve3Eigs) {
    ...
    GMRESSolveTestingMock<float> gmres_solve_s(A, b, u_sgl, 25, conv_tol_sgl);
...
TEST_F(GMRESSingleTest, DivergeBeyondSingleCapabilities) {
    ...
    GMRESSolveTestingMock<float> gmres_solve_s(A, b, u_sgl, 128, conv_tol_sgl);
    ...
    GMRESSolveTestingMock<float> gmres_solve_s_to_fail(A, b, u_sgl, 128, 0.1*u_sgl);
