...
Copy-Item (Join-Path ${matlab_dir} "create_read_matrices.m") `
          (Join-Path ${prec_casc_dir} "scripts/matlab/create_read_matrices.m")
Copy-Item (Join-Path ${matlab_dir} "create_solve_matrices.m") `
          (Join-Path ${prec_casc_dir} "scripts/matlab/create_solve_matrices.m")
Copy-Item (Join-Path ${matlab_dir} "convert_mat_to_CSV.m") `
          (Join-Path ${prec_casc_dir} "scripts/matlab/convert_mat_to_CSV.m")
